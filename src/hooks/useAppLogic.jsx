...
import { useTournamentLogic } from '../components/features/tournament/useTournamentLogic';
...
const sendChallengeInvite = (targetUser, targetPeerId, tournamentId = null, tournamentMatchId = null) => {
  if (!currentUser || !isConnectedToFirebase) return;
  playFx('click');
